      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-600 to-emerald-500 flex items-center justify-center text-white font-bold text-xl">
                G
              </div>
              <span className="text-lg font-bold">Gestor de Gastos</span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              Controle financeiro inteligente para quem busca clareza e organização no dia a dia.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-400">
            © 2026 Gestor de Gastos. Todos os direitos reservados.
          </p>
          <p className="text-sm text-slate-400">
            Feito com 💚 para sua tranquilidade financeira
          </p>
        </div>
      </div>
    </footer>
